...
public class Animation {
    ...
    public void buttonImageXLeft(final int start, final int stop, final int delay,
                                 final int increment, ButtonImage toAnimate) {
        if (toAnimate.getLocation().x != start) {
            return; // Si le bouton n'est pas à la position de départ, on ne fait rien.
        }
    ...
    public void buttonImageYDown(final int start, final int stop, final int delay,
                                 final int increment, ButtonImage toAnimate) {
        if (toAnimate.getLocation().y != start) {
            return; // Si le bouton n'est pas à la position de départ, on ne fait rien.
        }
    ...
    public void buttonImageYUp(final int start, final int stop, final int delay,
                               final int increment, ButtonImage toAnimate) {
        if (toAnimate.getLocation().y != start) {
            return; // Si le bouton n'est pas à la position de départ, on ne fait rien.
        }
    ...
    public void jLabelYUp(final int start, final int stop, final int delay,
                          final int increment, JLabel toAnimate) {
        if (toAnimate.getLocation().y != start) {
            return; // Si le JLabel n'est pas à la position de départ, on ne fait rien.
        }
    ...
    public void jLabelYDown(final int start, final int stop, final int delay,
                            final int increment, JLabel toAnimate) {
        if (toAnimate.getLocation().y != start) {
            return; // Si le JLabel n'est pas à la position de départ, on ne fait rien.
        }
